# File choice_testing_automatic_smaller.py: The simulated choice logic of
# drawing the number of games pseudorandomly from the range of
# integers, where integer ∈ <1000, 100 000>. The dimensions of the
# grid are drawn pseudorandomly from the range of integers, where integer
# ∈ <3, 6>.
...
class TheGame:
    """
    The game logic of choice between starting with 1 or starting with 2 and
    choosing the number of the games. There simulated.
    """
    ...
    try:
        ...
        # play. There the number of games to play are drawn pseudorandomly
        # from the range of integers, where integer ∈ <1000, 100 000>.

        number_of_the_games: int = randint(1000, 100000)
        ...
        number_of_the_games = randint(1000, 100000)
    ...
    if choice == 1:
        ...
        from game_1_testing_automatic_smaller import Game1First
        game = Game1First()
        ...
        choice_string: str = f"Choice: {choice}"
        print(choice_string)
        dimensions_of_the_matrix_string: str = f"Dimensions of the grid:" \
    ...
    # instantiated, and played the preselect number of times. The outcomes
    # of playing the number of games the player had chosen are summarized at
    # the end and written to a file.

    elif choice == 2:

        from game_2_testing_automatic_smaller import Game2First
        game = Game2First()
        ...
        print(choice_string)
        dimensions_of_the_matrix_string = f"Dimensions of the grid:" \
                                          f" {game.choose_dimensions} x {game.choose_dimensions}."
        print(dimensions_of_the_matrix_string)
