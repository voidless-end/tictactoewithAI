# File game_2_1_human_2_computer.py: The main game logic with 2
# starting first, human playing with 1 and computer with 2.

from numpy.core._multiarray_umath import ndarray

from tictactoe import AdjacencyMatrixTicTacToeAutomaticBuild1Human2Computer


class Game2First:
    """
    The main game logic. With 2 playing first and human
    playing with 1.
    """

    # Let's make available what was made beforehand and
    # instantiate an instance of
    # AdjacencyMatrixTicTacToeAutomaticBuild1Human2Computer class.
    ...
    def play(self):
        ...
        The uneven counter values direct the activity towards typing in the new 1,
        while the even counter values - towards drawing in the coordinates
        pseudorandomly from the prepopulated list for a new 2.
        The values of the counter variable greater or equal than
        (matrix_dimension - 1) and smaller than
        matrix_dimension_quadrupled are directed towards the block with the
        checking of the game results. There, the numpy.ndarray is plugged into
        the methods: the vertical_and_horizontal_win method (the numpy.ndarray
        ...
        with 1 may win (when that's the case the phrase "1 wins! is printed and
        ...
        the player with 2 may win and there are 2 possible scenarios of the
        ...
        matrix_dimension: int = \
            AdjacencyMatrixTicTacToeAutomaticBuild1Human2Computer.construct_matrix(
        ...
        while self.counter < (matrix_dimension_quadrupled - 1):
            ...
            while (matrix_dimension - 1) <= self.counter < matrix_dimension_quadrupled:
                ...
                if self.counter % 2 == 1:
                    ...
                    response_1: bool = AdjacencyMatrixTicTacToeAutomaticBuild1Human2Computer \
                        .vertical_and_horizontal_win(self.tic_tac_toe, matrix_1)

                    response_2: bool = \
                        AdjacencyMatrixTicTacToeAutomaticBuild1Human2Computer.diagonal_win(
                            self.tic_tac_toe, matrix_1)

                    response_3: bool = \
                        AdjacencyMatrixTicTacToeAutomaticBuild1Human2Computer.draw(
                            self.tic_tac_toe, matrix_1)
                    ...
                    response_2: bool = AdjacencyMatrixTicTacToeAutomaticBuild1Human2Computer \
                        .diagonal_win(self.tic_tac_toe, matrix_2)
