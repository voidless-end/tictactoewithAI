# File game_2_automatic_choice_of_dimensions.py: The main game
# logic. With 2 playing first.
...
class Game2First:
    ...
    tic_tac_toe: object = AdjacencyMatrixTicTacToeAutomaticBuildDimensionChoice()
        ...
        while self.counter < (matrix_dimension_quadrupled - 1):
            ...
            while self.counter < (matrix_dimension - 1):
                ...
                if self.counter % 2 == 1:
                    ...
                    matrix_2: ndarray = AdjacencyMatrixTicTacToeAutomaticBuildDimensionChoice \
            ...
            while (matrix_dimension - 1) <= self.counter < matrix_dimension_quadrupled:
                ...
                if self.counter % 2 == 1:
                    ...
                    matrix_1: ndarray = AdjacencyMatrixTicTacToeAutomaticBuildDimensionChoice \
                        .enter_the_coordinates_for_1_and_check_them(self.tic_tac_toe)
