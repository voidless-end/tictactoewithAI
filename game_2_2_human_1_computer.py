# File game_2_2_human_1_computer.py: The main game logic with starting
# 2, human playing with 2 and computer with 1.
...
class Game2First:
    """
    The main game logic. With 2 playing first and human playing with 2.
    """
    ...
    def play(self):
        ...
        The uneven counter values direct the activity towards drawing in
        the coordinates for a new 1 - pseudorandomly - from the prepopulated list,
        while the even counter values - towards typing in the coordinates
        ...
        while self.counter < (matrix_dimension_quadrupled - 1):
            ...
            while (matrix_dimension - 1) <= self.counter < matrix_dimension_quadrupled:
                ...
                if self.counter % 2 == 1:
                    ...
                    response_1: bool = AdjacencyMatrixTicTacToeAutomaticBuild2Human1Computer \
                    ...
                    response_2: bool = AdjacencyMatrixTicTacToeAutomaticBuild2Human1Computer \
