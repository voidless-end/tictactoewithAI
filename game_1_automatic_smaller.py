# File game_1_automatic_smaller.py: The game logic with starting 1 for
...
class Game1First:
    ...
    def play(self):
        """
        The matrix (the game's grid, numpy.ndarray) is constructed by
        ...
        the new 1, while the uneven counter values - towards typing in the new 2.
        ...
        method (the numpy.ndarray is checked for the possibility of the
        diagonal win) and the draw  method (the numpy.ndarray checked for the
        possibility of the draw). There, the game may resolve to 4 outcomes -
        3 of them results in the printout of the game results and the termination
        of the game - depending on the counter values. If the counter values are
        ...
        vertical_and_horizontal_win and the diagonal_win - is True and the "Draw"
        is printed if the response from the method draw is True. If the responses
        from the methods are False - the game in the cases of the both blocks
        continues.
        ...
        matrix_dimension: int = \
            AdjacencyMatrixTicTacToeAutomaticBuildSmaller.construct_matrix(
        ...
        while self.counter < (matrix_dimension_quadrupled - 1):
            ...
            while self.counter < (matrix_dimension - 1):
                ...
                if self.counter % 2 == 1:
                    ...
                    matrix_2: ndarray = \
                        AdjacencyMatrixTicTacToeAutomaticBuildSmaller \
