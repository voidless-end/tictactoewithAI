# File game_1_1_human_2_computer.py. : The game logic with starting 1,
# and the choice of dimensions. Human plays with 1 against
# the computer - pseudorandomly.
...
class Game1First:
    """
    The main game logic. With 1 playing first, and with human player playing
    with 1.
    """
    ...
    tic_tac_toe: object = AdjacencyMatrixTicTacToeAutomaticBuild1Human2Computer()
    ...
    def play(self):
        ...
        The even counter values direct the activity towards typing in the new 1,
        while the uneven counter values - towards drawing in the coordinates
        pseudorandomly from the prepopulated list. The values of the counter
        variable greater or equal than (matrix_dimension - 1) and smaller than
