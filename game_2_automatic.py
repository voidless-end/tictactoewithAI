# File game_2_automatic.py: The main game logic. With 2 playing first.
# For the automatic building and testing purposes.
...
class Game2First:
    ...
    # instantiate an instance of AdjacencyMatrixTicTacToeAutomaticBuild class.
        ...
        while self.counter < (matrix_dimension_quadrupled - 1):
            ...
            while (matrix_dimension - 1) <= self.counter < matrix_dimension_quadrupled:
                ...
                if self.counter % 2 == 1:
                    ...
                    response_2: bool = AdjacencyMatrixTicTacToeAutomaticBuild \
